...
var contextProvider = require('../../../lib/context-provider'),
    ...
    sequelizeHelper = require('../helpers/sequelizeHelper'),
...
sequelizeHelper.fillModels(super_user_sequelize, Sequelize);
var models = sequelizeHelper.fillModels(sequelize, Sequelize);
